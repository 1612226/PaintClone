...
namespace DrawingObjects
{
    ...
    public abstract class IDrawingObject
    {
        ...
        public void setDashStyle(DashStyle ds)
        {
            borderPen.DashStyle = ds;
        }
        ...
        {
            matrixElements = rotationMatrix.Elements;

            color = borderPen.Color;
            width = borderPen.Width;
            dashStyle = borderPen.DashStyle;

        }
        [OnDeserialized]
        public void OnDeserialized(StreamingContext context)
        {
            rotationMatrix = new Matrix(matrixElements[0], matrixElements[1], matrixElements[2], matrixElements[3], matrixElements[4], matrixElements[5]);
    ...
    public class ObjectList
    {
        ...
        public List<IDrawingObject> getList()
        {
            return list;
        }
        public void setList(List<IDrawingObject> l)
        {
            list = l;
        }
        ...
        public IDrawingObject getFocusObject()
        {
            foreach (var obj in list)
                if (obj.isFocused())
                    return obj;
